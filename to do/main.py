...
listbox=Listbox(frame1,font=('arial',12),width=40,height=15,bg="#32405b",fg="white",cursor="hand2",selectbackground="#5a95ff")
...
Button(root,image=Delete_icon,bd=0,command=deleteTask).pack(side=BOTTOM,pady=30)
